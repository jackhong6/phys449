classdef CoherentState
    % CoherentState Nx1 vector representation of a coherent state.
    %   A coherent state is the eigenvector with the largest eigenvalue
    %   of the angular momentum operator in the n direction.
    
    properties
        % v is the Nx1 eigenvector of Xn with eigenvalue j, 
        % where Xn is the angular momentum operator in the n direction.
        v, n, coordType
    end
